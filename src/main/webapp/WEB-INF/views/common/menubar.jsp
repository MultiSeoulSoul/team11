	...
	<div id="header">
        <div id="header_1">
            <div id="header_1_left">
                <img src="" alt="" onclick="location.href='${ pageContext.servletContext.contextPath }';">
            </div>
        ...
        <div id="header_2">
            <ul>
                ...
                <li><a href="${ pageContext.servletContext.contextPath }/member/member">회원관리</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/board/bbs">게시판</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/movie/genre">영화</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/food/food">음식</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/book/book">도서</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/file/filemain">파일</a></li>
                <li><a href="${ pageContext.servletContext.contextPath }/page/bbsMain">페이징</a></li>
